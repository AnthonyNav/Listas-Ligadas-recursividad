        ...
        do{
            ...
            switch (oplist) {
                ...
                case 2:
                    ...
                    break;
                default:
                    System.out.println("Opci贸n no v谩lida. Por favor, seleccione una opcion valida.");
                    break;
            }
        } while (oplist !=2);
        ...
        while (!salir) {
            ...
            switch (opcion) {
                case 1:
                    ...
                    System.out.println("Se encuentra en la posici髇: " + resultado.i);
                    break;
                case 2:
                    // Opcion para calcular el dato m铆nimo y contar su cantidad de repeticiones
                    ...
                    break;
                case 3:
                    // L贸gica para sumar todos los datos de la lista recursivamente
                    break;
                case 4:
                    // L贸gica para sumar los datos pares de la lista recursivamente
                    break;
                case 5:
                    // L贸gica para visualizar los datos pares de la lista recursivamente
                    break;
                case 6:
                    if (lista.estaVacia()) {
